...
<main>
  ...
  <div class = "card">
  <img src="https://images.unsplash.com/photo-1585589197566-b482772f8831?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt=""> 
    <div class="card-content">
      <h3>
       ${item.getVictim_name()}<br>
      </h3>
        ...
        <p>
	        	...
	        	Crime Name:${item.getPlace_where_crime_occured()}<br>
	        	Discription:${item.getCrime_report_to()}<br>
	        	Clues:${item.getIdentifying_marks_of_criminal()}<br>
	        	Gender of Suspect:${item.getGender_of_criminal()}<br>
