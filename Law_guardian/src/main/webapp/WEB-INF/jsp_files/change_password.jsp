...
.navbar {
  ...
  <body>
     ...
     <div class="wrapper">
	        ...
	        <div class="input-box ">
	          <input type="text" placeholder="Enter Your old password" id="password" name="oldpassword" required>
	          <div class="underline"></div>
	        </div>
	        <div class="input-box ">
	          <input type="text" placeholder="Enter Your new password" id="password" name="password" required>
	          <div class="underline"></div>
	        </div>
	        <div class="input-box">
	          <input type="password" placeholder="Confirm Your new Password"  id="password" name="confirmpassword" required>
	          <div class="underline"></div>
	        </div>
